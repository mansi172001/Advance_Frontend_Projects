    ...
    <div className='home'>
                ...
                <div className='testimonial'>
                  ...
                  <div className='detail'>
                    ...
                    <div className='info'>
                      <h3>stephan robot</h3>
                      <h4>web designer</h4>
                      <p>"Shopping on this e-commerce website for electronic products was a seamless experience, offering a wide range of high-quality gadgets and a user-friendly interface that made the entire process a delight.".</p>
                    </div>
                  </div>
                </div>
        ...
        <div className='banners'>
          <div className='container'>
            ...
            <div className='right_box'>
              <div className='top'>
                <img src='image/Multi-Banner-3.webp'className='b3' alt=''></img>
                <img src='image/Multi-Banner-4.jpg' className='b4' alt=''></img>
              </div>
